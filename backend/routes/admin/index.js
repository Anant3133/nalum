...
// Alumni Database routes (PostgreSQL)
router.get("/alumni-batches", protectAdmin, alumniDatabaseController.getBatches);
router.get("/alumni-by-batch/:batch", protectAdmin, alumniDatabaseController.getAlumniByBatch);
